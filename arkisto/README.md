...
Vanhentuneita sääsivuja. **Ei aktiivisessa käytössä, ei kehitetä.** Ainoa aktiivinen
versio on juuren `tusinapaja.html` (sivun otsikko `TUSINASÄÄ 12`).

- `tusinasaa.html` – tusinapajan edeltäjä
- `tusinapuuska.html`
- `saa_yr.html`
- `saa_fmi.html`
